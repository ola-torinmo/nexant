    ...
    <div className="w-full h-full bg-[#C4942D] mb-[200px] mt-[100px] md:mt-[0px] ipad-pro:mt-[0px] 2xl:mt-[0px] ">
        <div className='2xl:max-w-[1536px] md:w-[1028px] max-w-[600px] md:h-[600px] h-[700px]  md:mt-[150px] md:pt-[50px] pt-[30px] 2xl:pt-[25px] '>
            <div className=' md:pl-[0px]   '>
                <p className='text-white text-[11px] pb-[10px] md:w-[200px] ipad-pro:ml-[110%] 2xl:ml-[90%]  md:ml-[103%] ml-[180px] '>{props.title}</p>
            ...
            <div className=' flex md:flex-row flex-col md:w-[] '>
              <img src={blog1} className='2xl:w-[1500px] w-[600px] md:ml-[5%] 2xl:ml-[25%] ipad-pro:ml-[14%] md:pl-[0px] md:mb-[0px] mb-[20px]' />
