    ...
    <div className="w-full h-full bg-[#C4942D] mb-[200px]  ">
        <div className='md:w-[1028px] max-w-[600px] md:h-[600px] h-[700px]  md:mt-[150px] md:pt-[50px] pt-[30px] '>
            <div className=' md:pl-[0px]   '>
                <p className='text-white text-[11px] pb-[10px] md:w-[200px]  md:ml-[580px] ml-[180px] '>{props.title}</p>
                <h1 className='md:text-3xl text-lg md:ml-[270px] ml-[50px] md:w-[700px] w-[300px] pb-[60px] text-white text-center '>{props.body}</h1>
