...
const Footer = () => {
  return (
   <>
    <footer className="p-4 bg-[#C4942D1A]">
        <div className="mx-auto max-w-screen-xl  ">
            <div className="md:flex md:justify-between pt-[50px]  px-[50px]">
                <div className="mb-6 md:mb-0 pr-[200px]">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-[14px]">
                    <div>
                        <h2 className="mb-[70px] text-sm font-semibold text-gray-900 uppercase dark:text-white">Company</h2>
                    ...
                    <div>
                        <h2 className="mb-[70px] text-sm font-semibold text-gray-900 uppercase dark:text-white">Alternatives</h2>
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                    ...
                    <div>
                        <h2 className="mb-[70px] text-sm font-semibold text-gray-900 uppercase dark:text-white">Contact Us</h2>
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
            ...
            <div className='md:flex  pt-[50px]  '>
                ...
                <form className='px-12 pr-[220px]'>   
                    ...
                    <div className="relative">
                        ...
                        <button type="submit" className="text-white absolute end-2.5 bottom-2.5 bg-[#434344]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2  "><img src={arrow}  /></button>
                    </div>
                    <p id="helper-text-explanation" className="mt-2 text-sm text-[#C4942D] pt-6">Subscribe to our news letter </p>
                </form>


                <div className="flex mt-4 pt-5 space-x-6 sm:justify-center sm:mt-0">
                    <p className='text-[#C4942D]'>Follow our socials</p>
            ...
            {/* <hr className="my-6 border-gray-200 sm:mx-auto  md:mb-8 " /> */}
            
        </div>
       
    
    </footer>
    <section className="p-4 bg-[#C4942D]" >
    <div className=" mx-auto max-w-screen-xl place-items-center  text-center justify-center ">
                <span className="text-sm text-white text-center dark:text-gray-400">Copyright @ 2023:  
                <a href="#" className="hover:underline text-black">    www.nexantconsult.com</a>. All Rights Reserved.
                </span>
