        ...
        <section class=" bg-white  ">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md  ">
                ...
                <form action="#" class="space-y-8 border rounded my-[100px] md:p-[70px] p-[30px] mt-[-50px] shadow-lg shadow-[#C4942D] bg-white relative z-20  ">
                    ...
                    <button type="submit" class="py-3   text-sm font-medium  text-white rounded-lg  sm:w-fit md:px-[42.5%] px-[50%] w-[100px]  focus:ring-4 focus:outline-none bg-[#C4942D]"><p className='w-[150px] md:ml-[-20px] ml-[-70px] text-white'>Send message</p></button>
                </form>
        </div>
        </section>
    </>
