    ...
    <div className=''>
        <div className='2xl:max-w-[1536px] md:max-w-[1028px] max-w-[600px] m-auto w-full h-[900px] flex md:flex-row flex-col md:justify-between  items-center  md:pt-[0px] pt-[50px] md:mt-[-160px] mt-[30px]'>
            <div> 
                 ...
                 <h1 className='2xl:text-5xl md:text-4xl text-base 2xl:w-[600px] md:w-[400px] w-[330px] md:mt-[-20px] md:text-left text-center md:pb-[20px] pb-[20px] ' >{props.title}</h1>
                 <p className='2xl:text-xl md:text-base text-xs md:w-[500px] w-[330px]'>{props.p}</p>
            </div>
           <div className=''>
                <p className='2xl:text-xl md:text-base text-xs 2xl:w-[700px] md:w-[500px] w-[330px] pt-[30px] font-thin '>{props.description}</p>
           </div>
