        ...
        <div className='md:max-w-[1028px] max-w-[600px] m-auto w-full h-[900px] flex md:flex-row flex-col md:justify-between  items-center  md:pt-[0px] pt-[50px] md:mt-[-160px] mt-[30px]'>
            <div> 
                 <div className='flex'>
                    ...
                    <img src={props.png} className='pl-[70px] md:h-[100px] h-[70px]' alt="" />
                 </div>
                 <h1 className='md:text-3xl text-xl md:w-[400px] w-[400px] md:mt-[-20px] md:text-left text-center md:pb-[20px] pb-[20px] leading-10' >Design and construction of head over bridge </h1>
                 <p className='md:text-base text-xs md:w-[500px] w-[400px]'>International bewrey plc,Lagos state</p>
            </div>
           <div>
