   ...
   <div className='w-full h-full bg-[#C4942D1A]'>
        <div className='md:max-w-[1028px] max-w-[600px] 2xl:max-w-[1536px] md:m-auto md:pt-[80px] pt-[20px] md:px-0 px-[20px] ipad-prov:px-[5%]'>
            ...
            <div className='flex flex-row 2xl:space-x-12  md:space-x-9 space-x-2 md:-mt-[240px] -mt-[270px]  '>
                <img className=" 2xl:w-[600px] md:w-[400px] ipad-prov:w-[300px] w-[120px] 2xl:h-[500px] md:h-[300px] h-[200px] md:mt-[400px] ipad-prov:mt-[500px] mt-[350px]" src={Frame9}/>
                <img className=" 2xl:w-[600px] md:w-[300px] ipad-prov:w-[300px] w-[130px] 2xl:h-[700px] md:h-[500px] h-[300px] md:mt-[200px] ipad-prov:mt-[300px] mt-[300px]" src={Frame8}/>
                <img className=" 2xl:w-[600px] md:w-[300px] ipad-prov:w-[300px] w-[120px] 2xl:h-[900px] md:h-[700px] h-[200px] md:mt-[0px] ipad-prov:mt-[100px] mt-[350px]" src={Frame7}/>
            </div>
        </div>
