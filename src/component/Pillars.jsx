...
export default function Pillars  ()  {
  return (
        ...
        <div className="w-full bg-white py-10">
            <div className="2xl:max-w-[1536px] md:max-w-[1028px] max-w-[600px] m-auto grid md:grid-cols-2 ipad-prov:px-[5%] ipad-v:px-[3%]">
                <div className="flex flex-col justify-start gap-2 md:pl-[0px] pl-[7%] 2xl:pt-[100px] ipad-v:mt-[3%]">
