  ...
  return (
    <div className="w-full h-full bg-white  ">
        <div className='md:max-w-[1028px] max-w-[600px] h-[600px]  md:pt-[50px] md:mt-[100px] mt-[50px] '>
         ...
         <div className=' md:-mt-[100px] -mt-[70px] md:ml-[0%] ml-[1.5%]  ' >
           <img className='relative z-20 w-[1500px] h-[200px]  md:ml-[115px] ml-[-0.5%] ' src={Elipse} />
            <div className='flex space-x-3 proframe -mt-[100px] md:ml-[115px]  '>
                <img src={Pro2} className='md:w-[248px] w-[22%] md:h-[600px] h-[350px]' />
                <img src={Pro3} className='md:w-[248px] w-[22%] md:h-[500px] h-[300px]' />
                <img src={Pro4} className='md:w-[248px] w-[22%] md:h-[500px] h-[300px]' />
                <img src={Pro1} className='md:w-[248px] w-[22%] md:h-[500px] h-[300px] '  />

            </div>
            <img className='relative z-20 w-[1500px] h-[200px]  md:ml-[115px]   md:mt-[300px] mt-[100px] ' src={Elipse} />
          </div>  
        </div>
