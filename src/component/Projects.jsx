...
const Projects = () => {
  return (
    <div className="w-full h-full bg-white  ">
        <div className='md:max-w-[1028px] max-w-[600px] h-[600px] 2xl:pt-[20px] xl:pt-[10px]  md:pt-[50px] md:mt-[100px] mt-[50px] '>
          <div className='text-center md:pl-[150px] relative z-40  '>
              <p className='text-[#C4942D] 2xl:text-[13px] xl:text-[13px] text-[11px] pb-[10px] md:ml-[130px] 2xl:ml-[85%] xl:ml-[22%] '>Our projects</p>
              <h1 className='2xl:text-4xl xl:text-4xl md:text-3xl text-[lg] md:ml-[200px] ml-[50px] md:w-[600px] text-center w-[300px] pb-[10px] 2xl:ml-[60%] xl:ml-[28%]'>Our Latest projects showcase</h1>
              <p className='2xl:text-[16px] xl:text-[16px] md:text-[13px] text-[11px] 2xl:w-[900px] md:w-[700px] w-[300px] 2xl:ml-[45%] xl:ml-[23%] md:ml-[150px] ml-[50px] pb-[px]  '>To deliver world class infrastructure and engineering consultancy services by reinforcing our worldwide corporate alliances and upholding top-tier quality and ethical standards'</p>
          </div>

         <div className=' w-full md:-mt-[100px] -mt-[70px] md:pl-[0%] pl-[%] 2xl:ml-[35%] xl:ml-[6%]   ' >
