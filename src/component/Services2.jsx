        ...
        <div className='md:max-w-[1028px] max-w-[600px] m-auto w-full md:h-[1350px] h-[1850px]  '>
            ...
            <div>
                ...
                <div className=' md:space-x-12 flex md:flex-row flex-col md:justify-between  items-center md:mt-[-300px] mt-[-600px] pb-[20px] md:pb-[40px]'>
                    ...
                    <div class="md:w-[560px] w-[320px] md:h-[270px] h-[200px] p-6 border border-gray-200 rounded-lg bg-[#C4942D1A]  " >
                ...
                <div className=' md:space-x-12 flex md:flex-row flex-col items-center pb-[0px] md:pb-[40px] '>
                    ...
                    <div class="md:w-[560px] w-[320px] md:h-[270px] h-[200px]  p-6 border border-gray-200 rounded-lg bg-[#C4942D1A] md:mb-[0px] mb-[20px] " >
                        <img src={frame4} className='pb-[10px] md:w-[70px] w-[40px]'/>
                        
                        <a href="#">
                            <h5 class="mb-2 md:text-2xl text-base font-semibold tracking-tight text-[#C4942D] md:pb-[10px] pb-[1px] ">Transportation Initiative</h5>
                        </a>
                        <p class="mb-3 font-normal md:text-[12px] text-[9px] ">Excellence in Every Detail. We ensure the Pinnacle of Precision, Employing Rigorous Standards and Unyielding Commitment to Guarantee the Delivery of Impeccable Results, Redefining the Benchmark for Unmatched Quality in Construction</p>
                    ...
                    <div class="md:w-[560px] w-[320px] md:h-[270px] h-[200px]  p-6 border border-gray-200 rounded-lg bg-[#C4942D1A] md:mb-[0px] mb-[20px] " >
                        ...
                        <a href="#">
                            <h5 class="mb-2 md:text-2xl text-base font-semibold tracking-tight text-[#C4942D] md:pb-[10px] pb-[px] md:w-[400px] w-[260px] ">Project Management</h5>
                        </a>
                        <p class="mb-3 font-normal md:text-[12px] text-[9px]">We navigate the Tracks of Excellence, Offering a Specialized Approach that Redefines Railway Solutions. From Strategic Planning to Seamless Operations, Trust Nexant to Drive Your Railway Projects Forward with Unmatched Expertise and Industry Insight</p>
                ...
                <div className=' md:space-x-12 flex md:flex-row flex-col items-center md:pb-[40px] '>
                    ...
                    <div class="md:w-[560px] w-[320px] md:h-[270px] h-[200px]  p-6 border border-gray-200 rounded-lg bg-[#C4942D1A] md:mb-[0px] mb-[20px] " >
                        ...
                        <a href="#">
                            <h5 class="mb-2 md:text-2xl text-base font-semibold tracking-tight text-[#C4942D] md:pb-[10px] pb-[px] md:w-[400px] w-[260px] ">Oil and Gas</h5>
                        </a>
                        <p class="mb-3 font-normal md:text-[12px] text-[9px]">We navigate the Tracks of Excellence, Offering a Specialized Approach that Redefines Railway Solutions. From Strategic Planning to Seamless Operations, Trust Nexant to Drive Your Railway Projects Forward with Unmatched Expertise and Industry Insight</p>
