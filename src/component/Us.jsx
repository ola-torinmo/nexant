 ...
 const Us = () => {
  return (
    <div className='w-full h-full bg-[#C4942D1A]'>
        <div  className='2xl:max-w-[1536px] md:max-w-[1028px] md:m-auto mx-[05px] w-full h-[900px] flex md:flex-row flex-col md:justify-between  items-center  md:pt-[0px] pt-[50px]'>
          <div className='md:w-[500px] w-[350px] md:pl-[0px] pl-[0px] '>
              ...
              <h1 className='2xl:text-5xl md:text-3xl text-sm pb-[20px] 2xl:w-[800px]   md:w-[600px] w-[300px] md:text-left text-center '> Architects of Excellence, Pioneering Innovation in Construction.</h1>
