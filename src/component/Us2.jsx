 ...
 const Us2 = (props) => {
  return (
    <div className='w-full h-full bg-[#C4942D1A]'>
        <div  className='md:max-w-[1028px] 2xl:max-w-[1536px]  mx-[5px] w-full h-[900px] 2xl:h-[1300px] flex md:flex-row flex-col md:justify-between  items-center 2xl:pt-[00px]  md:pt-[100px] pt-[100px] '>
