 ...
 const Us3 = (props) => {
  return (
    <div className='w-full h-full bg-[#C4942D1A]'>
        <div  className='2xl:max-w-[1536px] md:max-w-[1028px] md:m-auto pl-[10px] md:pl-[0px] ipad-pro:pl-[0px] 2xl:pl-[0px] w-full h-[900px] flex md:flex-row flex-col md:justify-between  items-center  md:pt-[-100px] pt-[0px] ipad-prov:px-[5%]'>
          ...
          <div className='md:w-[500px] w-[350px] md:order-last order-first md:pl-[0px] pl-[0px] '>
              ...
              <h1 className='2xl:text-5xl  md:text-3xl text-sm pb-[20px] ipad-prov:w-[200px]  md:w-[600px] w-[200px] text-left text-[#C4942D] '>{props.title}</h1>
