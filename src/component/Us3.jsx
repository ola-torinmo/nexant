 ...
 const Us3 = (props) => {
  return (
    <div className='w-full h-full bg-[#C4942D1A]'>
        <div  className='md:max-w-[1028px] m-auto w-full h-[900px] flex md:flex-row flex-col md:justify-between  items-center  md:pt-[-100px] pt-[0px]'>
          <div><img src={props.img} className='md:w-[400px] w-[300px] pt-[50px]' /></div>
          <div className='md:w-[500px] w-[400px] md:order-last order-first md:pl-[0px] pl-[30px] '>
